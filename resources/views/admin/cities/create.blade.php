...
@section('header')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h1 class="h3 mb-0 fw-bold text-gray-800">Create City</h1>
            <p class="text-muted mb-0">Add a city with a base delivery charge</p>
        </div>
        <div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.cities.store') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <x-text-input id="base_charge" type="number" step="0.01" min="0" name="base_charge" value="{{ old('base_charge', '0') }}" required />
