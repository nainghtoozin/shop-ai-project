...
@section('header')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h1 class="h3 mb-0 fw-bold text-gray-800">Edit Product</h1>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.products.update', $product->id) }}" method="POST"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" 
                                               id="sku_display" value="{{ $product->sku }}" readonly 
                                               style="background-color: #f8f9fa;">
                                        <input type="hidden" name="sku" value="{{ $product->sku }}">
                                        <small class="form-text text-muted">SKU cannot be modified after creation.</small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            id="alert_stock" name="alert_stock"
                                            value="{{ old('alert_stock', $product->alert_stock) }}" min="0">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="file"
                                            class="form-control @error('new_images') is-invalid @enderror" id="new_images"
                                            name="new_images[]" multiple accept="image/*">
                                        <small class="form-text text-muted">You can upload multiple images. Select primary
                                            image from all images below.</small>
                                        @error('new_images')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div id="newImagePreview" class="row g-3 mb-3"></div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" id="featured" name="featured"
                                            value="0" {{ old('featured', $product->featured) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" value="0" id="not_for_sale"
                                            name="not_for_sale"
                                            {{ old('not_for_sale', $product->not_for_sale) ? 'checked' : '' }}>
...
@push('scripts')
    <script>
        let newImageFiles = [];
        let existingImageCount = {{ $product->images->count() }};
                            ...
                            <div class="col-md-3">
                                <div class="card">
                                    ...
                                    <div class="card-body p-2">
                                        ...
                                        <br>
                                        <small class="text-info">New Image ${index + 1}</small>
                                    </div>
                                </div>
                            </div>
                        `;
