...
@section('header')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h1 class="h3 mb-0 fw-bold text-gray-800">Create Delivery Category</h1>
            <p class="text-muted mb-0">Define extra delivery charge per item</p>
        </div>
        <div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.delivery-categories.store') }}">
                            @csrf

                            <div class="mb-3">
                                <x-input-label for="name" value="Category Name" />
                                <x-text-input id="name" type="text" name="name" value="{{ old('name') }}" placeholder="e.g., fragile" required />
